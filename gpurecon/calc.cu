...
__device__ Lorposition CalcLorPosition_30mm(short rsectorID1, short rsectorID2, short moduleID1, short moduleID2, short crystalID1, short crystalID2)
{
	//从晶体ID得到XYZ
	float ring_radius = 315.5;
	int module_num = 1;
	int rsector_num = 20;
	int crystalx_num = 1;
	float crystal_depth = 40;
	float crystal_pitch = 30;
	float PI = 3.1416;
	int crystalx_num_square = crystalx_num * crystalx_num;
	int half_z_crystals = 0;// (5 rings in z axis * 20 crystals per ring) / 2 
